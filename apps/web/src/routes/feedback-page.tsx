...
export function FeedbackPage() {
  ...
  return (
    <SecondaryShell route="feedback" fixture={fixture} title={t('反馈')}>
      <p className="fb-intro">
        {t('报告缺陷、提出功能建议，或指出使用中的不便之处。每一条我们都会查看。')}
      </p>
      <div className="fb-types">
        <span className="fb-types-label">{t('类型')}</span>
      ...
      <div className="fb-composer">
        ...
        <div className="fb-toolbar">
          ...
          <button type="button" aria-label={t('添加应用')}>
            <Grid2x2 />
          </button>
      ...
      <h2 className="fb-history-title">{t('你的反馈')}</h2>
      <p className="fb-history-empty">{t('尚未提交过反馈。')}</p>
    </SecondaryShell>
  );
}
