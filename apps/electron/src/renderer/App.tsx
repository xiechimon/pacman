...
import type { SessionDraft, DraftAttachmentRef } from '@pacman/shared/config'
...
import { TooltipProvider } from '@pacman/ui'
...
import { extractWorkspaceSlugFromPath } from '@pacman/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@pacman/shared/agent/thinking-levels'
...
export default function App() {
  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        ...
        if (needs.isFullyConfigured) {
          // If no workspace is selected (thin client without PACMAN_WORKSPACE_ID),
  ...
  // Platform actions for @pacman/ui components (overlays, etc.)
