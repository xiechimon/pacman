...
import { TurnCard, type ActivityItem } from '@pacman/ui'
...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message Pacman...',
  currentModel = 'claude-sonnet-4-6',
  permissionMode = 'ask',
  workingDirectory = '/Users/demo/projects/pacman',
  inputMode = 'freeform',
  compactMode = false,
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/pacman',
      },
      {
        name: 'seedRecentDirs',
