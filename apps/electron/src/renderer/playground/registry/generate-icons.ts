...
const TOOL_ICONS_DIR = path.join(process.env.HOME!, '.pacman/tool-icons')
const SOURCES_DIR = path.join(
  process.env.HOME!,
  '.pacman/workspaces/046a02d0-6521-98eb-8756-95ec4bb8c41f/sources'
)
...
// Native tool icons (from ~/.pacman/tool-icons/)
