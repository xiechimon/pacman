...
import { TiptapMarkdownEditor } from '@pacman/ui'
...
const events: PlannerTaskEvent[] = [
  ...
  { id: 'e4', taskId: 't1', type: 'task.session_snapshot_updated', at: 'Today · 18:42', actor: 'Pacman', payloadSummary: 'Refreshed snapshot summary' },
]
