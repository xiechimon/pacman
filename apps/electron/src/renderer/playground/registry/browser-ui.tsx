...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  ...
  'long-names': [
    {
      ...
      title: 'Pacman Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/pacmans-oss',
      title: 'Pacman OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
