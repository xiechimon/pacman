...
function BrowserAgentEmptyState({
  ...
  const handlePromptSelect = useCallback(async (prompt: string) => {
    ...
    const deepLinkUrl = `pacman://${deepLinkRoute}`
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    ...
    {
      id: 'mock-4',
      url: 'https://github.com/lukilabs/pacmans-oss',
      title: 'GitHub',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    {
      ...
      title: 'Pacmans Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'many-running': [
    ...
    {
      id: 'run-3',
      url: 'https://github.com/lukilabs/pacmans-oss/pulls',
      title: 'GitHub PRs',
      favicon: null,
      isLoading: true,
      canGoBack: false,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/pacmans-oss',
      title: 'Pacmans OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
