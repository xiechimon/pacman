...
const mockAutomations: AutomationListItem[] = [
  ...
  },
  {
    ...
    enabled: true,
    actions: [{ type: 'prompt', prompt: 'Log the label change: "$PACMAN_LABEL was added" to ~/label-log.txt' }],
    permissionMode: 'allow-all',
  ...
  },
  {
    ...
    actions: [{ type: 'prompt', prompt: 'Session $PACMAN_SESSION_NAME was marked as done. Summarise what was accomplished.' }],
