...
// Uses shared components from @pacman/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @pacman/ui) */}
      <section>
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @pacman/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @pacman/ui)',
