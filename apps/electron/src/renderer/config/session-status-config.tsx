...
import type { StatusConfig } from '@pacman/shared/statuses'
import { isEmoji } from '@pacman/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@pacman/shared/colors'
