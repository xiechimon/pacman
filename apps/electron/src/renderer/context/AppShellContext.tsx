...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@pacman/shared/config').DraftAttachmentRef[]
  ...
  labels?: import('@pacman/shared/labels').LabelConfig[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@pacman/core').ContentBadge[]) => void
