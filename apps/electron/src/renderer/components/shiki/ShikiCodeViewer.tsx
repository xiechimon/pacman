 ...
 *
 * This thin wrapper imports the portable component from @pacman/ui
 * and connects it to Electron's ThemeContext and preset themes.
 */

import * as React from 'react'
import { ShikiCodeViewer as BaseShikiCodeViewer, type ShikiCodeViewerProps as BaseProps } from '@pacman/ui'
