 ...
 * syntax highlighting. Falls back to pacman-dark/pacman-light (transparent bg)
 * when no Shiki theme is configured.
 */

import * as React from 'react'
import { ShikiDiffViewer as BaseShikiDiffViewer, type ShikiDiffViewerProps as BaseProps } from '@pacman/ui'
