...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote Pacman Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!homeDir) return
    const defaultBasePath = `${homeDir}/.pacman/workspaces`
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote Pacman Server for this workspace."}
      />
