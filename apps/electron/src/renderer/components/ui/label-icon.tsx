...
import type { IconSize } from '@pacman/shared/icons'
import type { EntityColor } from '@pacman/shared/colors'
...
interface LabelIconProps {
  /** Label configuration (matches LabelConfig from @pacman/shared/labels) */
  label: {
    id: string
