...
import { Icon_Home, Spinner } from '@pacman/ui'
...
import type { LabelConfig } from '@pacman/shared/labels'
import { parseMentions } from '@/lib/mentions'
import { RichTextInput, type RichTextInputHandle } from '@/components/ui/rich-text-input'
import { Tooltip, TooltipContent, TooltipTrigger } from '@pacman/ui'
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { type ThinkingLevel, THINKING_LEVELS, getThinkingLevelNameKey } from '@pacman/shared/agent/thinking-levels'
    ...
    <form onSubmit={handleSubmit}>
      ...
      >
        ...
        {/* Controlled EditPopover for "Add New Label" — opens when user selects
            ...
            Electron but launched the desktop app from the WebUI via `pacman://`.
        ...
        <div className="relative">
          ...
          {/* Compact mode: permission mode drawer + standard icon badges for attach/sources/working dir.
              ...
              anchored to the right (pacmans-oss#798). overflow-hidden is safe — Radix Drawer /
