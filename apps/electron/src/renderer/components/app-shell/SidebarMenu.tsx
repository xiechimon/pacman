...
import { getDocUrl, type DocFeature } from '@pacman/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('pacman://action/new-session?window=focused')}>
