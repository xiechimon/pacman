...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@pacman/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@pacman/shared/labels'
