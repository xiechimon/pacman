 ...
 * Shows both default patterns (from ~/.craft/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.craft/permissions/default.json.
...
import { type PermissionsConfigFile } from '@pacman/shared/agent/modes'
import {
...
import { getDocUrl } from '@pacman/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.craft/permissions/default.json.
