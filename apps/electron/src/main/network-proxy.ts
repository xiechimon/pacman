...
import { getNetworkProxySettings, setNetworkProxySettings } from '@pacman/shared/config/storage';
import type { NetworkProxySettings } from '@pacman/shared/config/types';
