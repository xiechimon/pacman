 ...
 */
import { getAuthState, getSetupNeeds } from '@pacman/shared/auth'
import { isSetupDeferred, setSetupDeferred } from '@pacman/shared/config/storage'
import { getCredentialManager } from '@pacman/shared/credentials'
import { prepareClaudeOAuth, exchangeClaudeCode, hasValidOAuthState, clearOAuthState, prepareMcpOAuth } from '@pacman/shared/auth'
import { validateMcpConnection } from '@pacman/shared/mcp'
