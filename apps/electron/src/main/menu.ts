 ...
 * Includes only relevant items for the Pacmans app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'Pacmans',
      submenu: [
        { role: 'about' as const, label: i18n.t('menu.aboutPacman') },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: i18n.t('menu.hidePacman') },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: i18n.t('menu.quitPacman') }
      ]
    }] : []),
