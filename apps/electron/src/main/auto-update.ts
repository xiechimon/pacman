 ...
 * electron-updater library. The update feed URL is intentionally empty (pacman
 * does not publish via the original distribution channel); set
 * PACMAN_UPDATE_FEED_URL to enable.
 *
 * Platform behavior:
