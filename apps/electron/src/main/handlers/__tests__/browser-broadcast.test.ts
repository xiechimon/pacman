 ...
 * Pacmans window's id (set by updateClientWorkspace), but remote-bridged
...
import type { BrowserInstanceInfo } from '@pacman/shared/protocol'
...
describe('browser handler — workspace filtering', () => {
  ...
  describe('LIST handler', () => {
    ...
    it('returns ALL instances regardless of ctx.workspaceId (renderer filters)', async () => {
      ...
      // local Pacmans window's workspace id, but remote-bridged tabs are
