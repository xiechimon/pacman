...
export default [
  ...
  // TypeScript/React files
  {
    ...
    rules: {
      ...
      'pacman/no-direct-navigation-state': 'error',
  ...
  // Enforce backend abstraction boundary in Electron main process.
  {
    ...
    rules: {
      'no-restricted-imports': ['error', {
        paths: [
          {
            name: '@pacman/shared/codex',
            message: 'Use provider-agnostic APIs from @pacman/shared/agent/backend instead.',
          },
          {
            name: '@pacman/shared/agent/claude-agent',
            message: 'Provider backends must stay behind @pacman/shared/agent/backend.',
          },
          {
            name: '@pacman/shared/agent/pi-agent',
            message: 'Provider backends must stay behind @pacman/shared/agent/backend.',
          },
        ],
      }],
      ...
      'no-restricted-syntax': ['error',
        {
          ...
          message: 'Do not call provider APIs directly in Electron model fetchers. Delegate to fetchBackendModels() from @pacman/shared/agent/backend.',
        },
        {
