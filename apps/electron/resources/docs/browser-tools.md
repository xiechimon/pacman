...
Use `browser_tool` to control built-in browser windows (Chromium) inside Pacman.
...
- Before first browser tool usage, the agent must read this guide (`~/.pacman/docs/browser-tools.md`).
