...
This guide explains how to create and configure skills in Pacman.

> **CLI-first workflow (recommended):** Use `pacman skill ...` commands instead of editing `SKILL.md` files directly.
> - `pacman skill --help`
...
Pacman uses **the identical SKILL.md format** as the Claude Code SDK. This means:

1. **Format compatibility**: Any skill written for Claude Code works in Pacman
