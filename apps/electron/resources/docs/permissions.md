...
> **CLI-first workflow (recommended):** Use `pacman permission ...` commands instead of editing JSON directly.
> - `pacman permission --help`
...
- Source: `~/.pacman/workspaces/{slug}/sources/{source}/permissions.json`
