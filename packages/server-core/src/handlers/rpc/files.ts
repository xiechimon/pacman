...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@pacman/shared/protocol'
import type { StoredAttachment } from '@pacman/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@pacman/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@pacman/shared/sessions'
import { getWorkspaceByNameOrId } from '@pacman/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@pacman/server-core/services'
import { sanitizeFilename, validateFilePath, getWorkspaceAllowedDirs } from '@pacman/server-core/handlers'
