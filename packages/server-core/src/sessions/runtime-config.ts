import type { AgentProvider, LlmAuthType } from '@pacman/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@pacman/shared/config'
