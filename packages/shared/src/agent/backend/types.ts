 ...
 * The Pacman facade delegates to these backends, enabling provider switching while
 ...
 * - AsyncGenerator for streaming: Consistent with existing Pacman API
 */
 ...
 * 2. Enable the facade pattern in Pacman
...
export interface AgentBackend {
   ...
   * (pacmans-oss#804). Set by SessionManager after a successful mid-turn
