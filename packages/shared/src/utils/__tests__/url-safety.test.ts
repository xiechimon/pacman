...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies pacman:// as internal-deeplink', () => {
    expect(classifyExternalUrl('pacman://settings').kind).toBe('internal-deeplink')
  })
...
describe('formatBlockedUrlError', () => {
  ...
  it('returns an empty string for non-dangerous classifications', () => {
    ...
    expect(formatBlockedUrlError(classifyExternalUrl('pacman://settings'))).toBe('')
  })
})
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('pacman://settings')).toBe(false)
  })
