 ...
 * Extracted here so handler code in @pacman/server-core can import
 * from @pacman/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@pacman/core/types'
...
export interface TaskGenerateResult {
  ...
  slug: string
  /** Parsed TaskSpec when valid (consumers cast to TaskSpec from @pacman/shared/tasks). */
  spec?: unknown
...
export interface TaskGetResult {
  slug: string
  validation: TaskValidationResultDto
  /** The parsed TaskSpec (from @pacman/shared/tasks) when valid; consumers cast. */
  spec?: unknown
