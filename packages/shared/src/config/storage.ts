...
import type { StoredAttachment, StoredMessage } from '@pacman/core/types';
...
import type { Workspace, AuthType } from '@pacman/core/types';
...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for Pacmans',
  defaults: {
...
/**
 * Load config defaults from ~/.craft/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  backupConfigFile();
  // Initialize bundled docs (creates ~/.craft/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export type { StoredAttachment, StoredMessage } from '@pacman/core/types';
...
/**
 * Get the path to the app-level theme override file (~/.craft/theme.json).
 */
 ...
 * Preset themes are stored at ~/.craft/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.craft/tool-icons/
 */
