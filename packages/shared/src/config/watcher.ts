 ...
 *
 * Watched paths:
 * - ~/.pacman/config.json - Main app configuration
 * - ~/.pacman/preferences.json - User preferences
 * - ~/.pacman/theme.json - App-level theme overrides
 * - ~/.pacman/themes/*.json - Preset theme files (app-level)
 * - ~/.pacman/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.pacman/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.pacman/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.pacman/permissions/)
