...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@pacman/core/types';
 ...
 * Re-exported from @pacman/core for convenience
 */
export type { StoredMessage } from '@pacman/core/types';
...
export interface SessionHeader {
  ...
  /** SDK session ID (captured after first message) */
  sdkSessionId?: string;
  /** Workspace root path (stored as portable path, e.g., ~/.craft/...) */
  workspaceRootPath: string;
  /** Optional user-defined name */
  name?: string;
  createdAt: number;
