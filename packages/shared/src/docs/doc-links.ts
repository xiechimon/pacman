...
export const DOCS: Record<DocFeature, DocInfo> = {
  ...
  'app-settings': {
    ...
    title: 'App Settings',
    summary:
      'Configure global app settings like your default model, authentication method, and workspace list. Settings are stored in ~/.pacman/config.json.',
  },
  preferences: {
    path: '/reference/config/preferences',
    title: 'Preferences',
    summary:
      'Personal preferences like your name, timezone, and language that help the agent personalize responses. Stored in ~/.pacman/preferences.json.',
  },
  automations: {
