 ...
 * @param workspaceRootPath - Absolute path to workspace folder (e.g., ~/.pacman/workspaces/xxx)
...
export async function createSource(
  ...
  // (bundled guides removed - service-specific guidance lives in the product docs at #)
