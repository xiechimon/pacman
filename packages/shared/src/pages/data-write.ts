 ...
 * server (Bun), in dev and packaged builds (PACMAN_BUN).
 *
...
import { resolveScriptRuntime } from '@pacman/session-tools-core';
import type { PageConfig, PageDataSnapshot } from '@pacman/core';
...
export function buildPageDataWriterScript(input: {
  ...
  return `// Generated by @pacman/shared/pages/data-write — self-contained on purpose.
