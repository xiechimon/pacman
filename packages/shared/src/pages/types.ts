 ...
 *
 * The domain/protocol types live in @pacman/core (renderer-safe); this
 * module re-exports them and adds the storage-layer shapes that carry
 * absolute paths or creation inputs.
 *
 * File structure: see the docblock in @pacman/core types/page.ts.
 */

import type { PageActionGrant, PageConfig, PageKind, PageRefreshSpec } from '@pacman/core';

// Re-export the core page types so consumers can import everything from
// '@pacman/shared/pages' (mirrors how sources/projects expose types).
export type {
  PageKind,
  PageScriptRuntime,
  PageRefreshSpec,
