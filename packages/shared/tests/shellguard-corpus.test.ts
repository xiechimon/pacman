...
const TEST_MODE_CONFIG = {
  ...
  readOnlyBashPatterns: [
    ...
    // pacman CLI read-only
    { regex: /^pacman\s+label\s+(list|get)\b/, source: '^pacman\\s+label\\s+(list|get)\\b', comment: 'pacman label read-only operations' },
    { regex: /^pacman\s+source\s+(list|get|validate|test)\b/, source: '^pacman\\s+source\\s+(list|get|validate|test)\\b', comment: 'pacman source read-only operations' },
    { regex: /^pacman\s+skill\s+(list|get|validate|where)\b/, source: '^pacman\\s+skill\\s+(list|get|validate|where)\\b', comment: 'pacman skill read-only operations' },
    { regex: /^pacman\s+automation\s+(list|get|validate|history|last-executed|test|lint)\b/, source: '^pacman\\s+automation\\s+(list|get|validate|history|last-executed|test|lint)\\b', comment: 'pacman automation read-only operations' },
    { regex: /^pacman\s*$/, source: '^pacman\\s*$', comment: 'pacman bare invocation' },
    { regex: /^pacman\s+(label|source|skill|automation)\s+--help\b/, source: '^pacman\\s+(label|source|skill|automation)\\s+--help\\b', comment: 'pacman entity help flags' },
    { regex: /^pacman\s+--(help|version|discover)\b/, source: '^pacman\\s+--(help|version|discover)\\b', comment: 'pacman global flags' },
...
// ============================================================
// Group 27: pacman CLI allowlist
// ============================================================

describe('ShellGuard corpus: pacman CLI allowlist', () => {
  const shouldAllow = [
    'pacman',
    'pacman --help',
    'pacman --version',
    ...
    'pacman skill --help',
    'pacman skill list',
    'pacman skill get commit-helper',
    'pacman skill where commit-helper',
    'pacman skill validate commit-helper',
    'pacman automation list',
    'pacman automation get abc123',
    'pacman automation validate',
    'pacman automation history abc123 --limit 5',
    'pacman automation last-executed abc123',
    'pacman automation test abc123 --match "x"',
    'pacman automation lint',
  ];

  const shouldBlock = [
    'pacman label create --name Bug',
    'pacman label update bug --name "Bug Report"',
    'pacman label delete bug',
    'pacman label move bug --parent root',
    'pacman label reorder --parent root a b c',
    'pacman source create --name Linear --provider linear --type mcp',
    'pacman source update linear --json "{\"enabled\":false}"',
    'pacman source delete linear',
    'pacman skill create --name "Review" --description "x"',
    'pacman skill update review --json "{\"description\":\"y\"}"',
    'pacman skill delete review',
    'pacman automation create --event UserPromptSubmit --prompt "x"',
    'pacman automation update abc123 --json "{\"enabled\":false}"',
    'pacman automation delete abc123',
    'pacman automation enable abc123',
    'pacman automation disable abc123',
